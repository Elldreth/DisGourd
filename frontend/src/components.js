...
export const ServerSidebar = ({ servers, activeServer, onServerSelect }) => {
  return (
    <div className="bg-gray-900 w-18 flex flex-col items-center py-3 space-y-2">
      {/* Discord Home Button */}
      <div className="bg-discord-blurple w-12 h-12 rounded-2xl flex items-center justify-center cursor-pointer hover:rounded-xl transition-all duration-200">
      ...
      {servers.map((server) => (
        ...
        >
          ...
          <div className={`w-12 h-12 ${
            server.isActive ? 'rounded-xl' : 'rounded-3xl group-hover:rounded-xl'
